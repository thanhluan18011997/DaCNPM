...
public class RoleAndPermissionSeeding implements ApplicationListener {
    ...
    public void onApplicationEvent(ApplicationEvent applicationEvent) {
        ...
        if (permissionsTotal == 0 && roleTotal == 0) {
            createRolesAndPermission(Arrays.asList("ROLE_ADMIN", "ROLE_USER"), Arrays.asList("READ_KQ HTRL",
                    "READ_PersonalInformation", "READ_Lịch học", "READ_Điểm", "READ_Lịch thi", "READ_Permission","READ_class","READ_collaborator","READ_semester"));
        }
